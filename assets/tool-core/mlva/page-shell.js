(function () {
  ...
  function buildRelatedWorkConfig(opts) {
    ...
    return {
      toolId: opts.toolId,
      sourceUrl: opts.relatedWorkSourceUrl || '/mlv-tools/assets/related-work.json',
      publicationsSourceUrl: opts.publicationsSourceUrl || window.PUBLICATIONS_SOURCE_URL || 'https://enheragu.github.io/publications-data.json',
    };
  }
