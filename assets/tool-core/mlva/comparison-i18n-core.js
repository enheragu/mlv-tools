(function () {
  ...
  var base = {
    en: {
      ...
      mcTrialsLabel: 'Number of Monte Carlo simulations',
      bsTrialsLabel: 'Number of Bootstrap resamples',
      ...
      simVariesNote: 'These are Monte Carlo and Bootstrap estimates, so they shift slightly each time you run them — the simulation seed is not fixed on purpose. That wobble is the very run-to-run variance this analysis is about.',
    ...
    es: {
      ...
      mcTrialsLabel: 'N\u00famero de simulaciones Monte Carlo',
      bsTrialsLabel: 'N\u00famero de remuestreos Bootstrap',
      ...
      simVariesNote: 'Son estimaciones Monte Carlo y Bootstrap, así que cambian un poco cada vez que las ejecutas — la semilla de la simulación no se fija a propósito. Ese baile es precisamente la varianza entre ejecuciones de la que trata este análisis.',
