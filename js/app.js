(function () {
  ...
  var tools = [
    {
      ...
      imageDark: '/mlv-tools/replication-and-comparison/assets/og-image.svg',
      imageLight: '/mlv-tools/replication-and-comparison/assets/og-image-light.svg'
    },
    {
      key: 'ablationTests',
      section: 'mlv-tools',
  ...
  var LANDING_SECTIONS = [
    {
      sectionId: 'mlv-tools',
      gridId: 'ml-tools-grid',
      catalogUrl: '/mlv-tools/tools-catalog.json',
    }
  ];
  ...
  function renderCardsInGrid(gridId, toolList) {
    ...
    var cards = toolList.map(function (tool) {
      ...
      return [
        ...
        '<img class="tool-cover" src="' + coverImage + '" alt="' + content.title + ' preview" onerror="this.onerror=null;this.src=\'/mlv-tools/assets/og-image.png\';">',
  ...
  function renderCards() {
    ...
    renderCardsInGrid('ml-tools-grid', currentTools.filter(function (tool) { return tool.section === 'mlv-tools'; }));
  }
  ...
  function renderRelatedWork() {
    ...
    window.SharedRelatedWork.init({
      ...
      toolId: 'Landing',
      lang: state.lang,
      sourceUrl: '/mlv-tools/assets/related-work.json',
  ...
  function applyLanguage() {
    ...
    setElText('ml-tools-title', langCopy.mlToolsTitle);
